...
<head>
    ...
    <style type='text/tailwindcss'>
        .btn {
            @apply rounded-md px-2 text-slate-700 py-1 text-center font-medium shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-50
        }
        .link {
...
<body class="container mx-auto mt-10 mb-10 max-w-lg">
    ...
    <div x-data="{flash: true}">
        @if(session()->has('success'))
            ...
            role='alert'>
                <strong class='front-bold'>Success!</strong>    
